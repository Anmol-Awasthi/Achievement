...
const Home = ({ addAchievement }) => {
  ...
  const handleChange = (e) => {
    ...
    localStorage.setItem(
      "achievementFormData",
      JSON.stringify({ ...form, [name]: value })
    );
  };
  ...
  const handleFileChange = (e) => {
    ...
    localStorage.setItem(
      "achievementFormData",
      JSON.stringify({ ...form, file, fileUrl })
    );
  };
      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-4xl">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <label
              htmlFor="date"
              className="w-full p-2 rounded bg-gray-700 text-white focus:outline-none cursor-pointer block"
            >
              <input
                type="date"
                id="date"
          ...
          <div className="mb-6">
            <label className="block text-gray-400 mb-2" htmlFor="file">
              Upload Media
            </label>
            <input
              type="file"
